...
component accessors="true"{
  ...
  */
  property name="servers" default="127.0.0.1:8091";
  /**
  ...
  */
  ...
  /**
  * The connection timeout in seconds when creating a connection to a bucket
  */
  property name="connectionTimeout" default="5";
  /**
